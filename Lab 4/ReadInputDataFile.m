function [COOR,CN,TypeElement,TypeElementB, celasglo,  DOFr,dR, Tnod,CNb,fNOD,Fpnt,NameFileMesh,typePROBLEM,celasgloINV, BoundaryNodes, eignumb, densglo] = ReadInputDataFile(NAME_INPUT_DATA)  
