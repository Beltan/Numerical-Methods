function [d strainGLO stressGLO  React posgp Ftrac DOFl Mll Kll]= SolveElastFE(COOR,CN,TypeElement,TypeElementB, celasglo,  DOFr,dR,...  
    Tnod,CNb,fNOD,Fpnt,typePROBLEM,celasgloINV, densglo)  
...
% A) Global stiffness and mass matrixes
% ------------------------------
...
disp('Solving...')
[d, strainGLO, stressGLO, React, posgp, DOFl, Kll, Mll] = SolveELAS(K,M,Fb,...
Ftrac,dR,DOFr,COOR,CN,TypeElement,celasglo,typePROBLEM,celasgloINV) ; 
